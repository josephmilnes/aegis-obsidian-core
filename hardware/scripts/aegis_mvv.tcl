...
#
# aegis_mvv.tcl: Tcl script for re-creating project 'project_aegis_mvv'
#
# Generated by Vivado on Sun Dec 21 18:58:54 -0700 2025
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/genesis_rom.v"]"\
 "[file normalize "$origin_dir/src/aes_core.v"]"\
 "[file normalize "$origin_dir/src/aegis_vault_controller.v"]"\
 "[file normalize "$origin_dir/src/zcu106_pcie.xdc"]"\
 "[file normalize "$origin_dir/src/aegis_tb.v"]"\
 "[file normalize "$origin_dir/src/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "project_aegis_mvv"
...
set orig_proj_dir "[file normalize "$origin_dir/project_aegis_mvv"]"
...
set file "new/aegis_vault_controller.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/zcu106_pcie.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/zcu106_pcie.xdc"
...
set_property -name "top" -value "aegis_tb" -objects $obj
...
if { [get_files [list aes_core.v]] == "" } {
  import_files -quiet -fileset sources_1 "$origin_dir/src/aes_core.v"
}
if { [get_files [list aegis_vault_controller.v]] == "" } {
  import_files -quiet -fileset sources_1 "$origin_dir/src/aegis_vault_controller.v"
}
...
# aegis_vault_controller
  ...
  set tamper_mesh_sense [ create_bd_port -dir I tamper_mesh_sense ]
...
\
  ...
  # Create instance: aegis_vault_controll_0, and set properties
  set block_name aegis_vault_controller
  set block_cell_name aegis_vault_controll_0
  if { [catch {set aegis_vault_controll_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aegis_vault_controll_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net aegis_vault_controll_0_m_axis [get_bd_intf_pins aegis_vault_controll_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins aegis_vault_controll_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axi_smc_1_M02_AXI [get_bd_intf_pins axi_smc_1/M02_AXI] [get_bd_intf_pins aegis_vault_controll_0/s_axi]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins xdma_0/S_AXI_LITE] [get_bd_intf_pins axi_smc_1/M01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI1 [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins xdma_0/S_AXI_B]
  connect_bd_intf_net -intf_net xdma_0_M_AXI_B [get_bd_intf_pins xdma_0/M_AXI_B] [get_bd_intf_pins axi_smc/S02_AXI]
  connect_bd_intf_net -intf_net xdma_0_pcie_mgt [get_bd_intf_ports pci_express_x1] [get_bd_intf_pins xdma_0/pcie_mgt]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins axi_smc_1/S01_AXI]
  ...
  connect_bd_net -net aegis_vault_controll_0_m_axis_tdata  [get_bd_pins aegis_vault_controll_0/m_axis_tdata] \
  [get_bd_pins axi_dma_0/s_axis_s2mm_tdata]
  connect_bd_net -net aegis_vault_controll_0_m_axis_tlast  [get_bd_pins aegis_vault_controll_0/m_axis_tlast] \
  [get_bd_pins axi_dma_0/s_axis_s2mm_tlast]
  connect_bd_net -net aegis_vault_controll_0_m_axis_tvalid  [get_bd_pins aegis_vault_controll_0/m_axis_tvalid] \
  [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid]
  connect_bd_net -net aegis_vault_controll_0_s_axis_tready  [get_bd_pins aegis_vault_controll_0/s_axis_tready] \
  ...
  [get_bd_pins aegis_vault_controll_0/reset_n]
  connect_bd_net -net tamper_mesh_sense_0_1  [get_bd_ports tamper_mesh_sense] \
  [get_bd_pins aegis_vault_controll_0/tamper_mesh_sense]
  ...
  [get_bd_pins aegis_vault_controll_0/clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0  [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] \
  [get_bd_pins proc_sys_reset_0/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs aegis_vault_controll_0/s_axi/reg0] -force
  assign_bd_address -offset 0xB0100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_B] [get_bd_addr_segs xdma_0/S_AXI_B/BAR0] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs xdma_0/S_AXI_B/BAR0] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs xdma_0/S_AXI_B/BAR0] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_B] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
